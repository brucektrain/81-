...
function ENT:Initialize()
	...
	self:SetModel("models/train/russian/type_d.mdl")
	self.BaseClass.Initialize(self)
	self:SetPos(self:GetPos() + Vector(0,0,140))
	
	-- Create seat entities
	self.DriverSeat = self:CreateSeat("driver",Vector(445,-40,85)) 
	self.InstructorsSeat = self:CreateSeat("instructor",Vector(445,40,85))
	...
	-- Create Bogeys
	self.FrontBogey = self:CreateBogey(Vector( 450-120,0,31.5),Angle(0,180,0),true) 
	self.RearBogey = self:CreateBogey(Vector(-485+155,0,31.5),Angle(0,0,0),false)
