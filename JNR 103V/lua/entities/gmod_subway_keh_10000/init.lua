...
function ENT:Initialize()
	...
	self:SetModel("models/train/JNR/keihan_10000_ct.mdl")
	self.BaseClass.Initialize(self)
	self:SetPos(self:GetPos() + Vector(0,0,140))
	
	-- Create seat entities
	self.DriverSeat = self:CreateSeat("driver",Vector(400,40,78)) 
	self.InstructorsSeat = self:CreateSeat("instructor",Vector(405,-40,78))
	...
	-- Create Bogeys
	self.FrontBogey = self:CreateBogey(Vector( 425-120,0,30),Angle(0,180,0),true) 
	self.RearBogey = self:CreateBogey(Vector(-460+170,0,30),Angle(0,0,0),false)
