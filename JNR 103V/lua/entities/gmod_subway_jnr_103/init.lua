...
function ENT:Initialize()
	...
	self:SetModel("models/train/JNR/JNR_103V.mdl")
	self.BaseClass.Initialize(self)
	self:SetPos(self:GetPos() + Vector(0,0,140))
	
	-- Create seat entities
	self.DriverSeat = self:CreateSeat("driver",Vector(435,40,75)) 
	self.InstructorsSeat = self:CreateSeat("instructor",Vector(435,-40,75))
	...
	-- Create Bogeys
	self.FrontBogey = self:CreateBogey(Vector( 455-120,0,35),Angle(0,180,0),true) 
	self.RearBogey = self:CreateBogey(Vector(-490+170,0,35),Angle(0,0,0),false)
